...
and pre-allocated buffer management via :class:`ResultStore`.

These utilities operate on solver data structures so they can be tested
independently of the full solver loop.
"""
...
from .store import ResultStore  # noqa: E402, F401
